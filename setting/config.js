...
wait: "```☠️ WAIT FOR  ☠︎︎ 𝐉𝐀𝐕𝐀 𝐆𝐎𝐃 ☠︎︎😈 ⚡ *Power of Java intensifies...*  💀 *Brace yourself — The JAVA GOD is rising.*```",
   ...
   on: "`✔️☠︎︎ 𝐉𝐀𝐕𝐀 𝐆𝐎𝐃 ☠︎︎𝗔𝗖𝗧𝗜𝗩𝗘 ⚔️`  🔥 *The JAVA GOD is unleashed. Power running at full force.*  🕳️ *Enter if you dare.*", 
   prem: "`⛧ PREMIUM ACCESS ONLY ⛧`  🩸 *This feature is restricted to premium users.*  📲 *Add your number to the database to unlock the dark tier.*  🕳️ *No entry without clearance. The JAVA GOD does not negotiate.*", 
   off: "`❌ ☠︎︎ 𝐉𝐀𝐕𝐀 𝐆𝐎𝐃 ☠︎︎𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗢𝗙𝗙 ⚰️`  🕳️ *The JAVA GOD has gone dark. All systems offline.*  ⚡ *Recharge and prepare for the next awakening.*",
   query: {
...
global.onlyowner = `\`[ ⚡ ] ☠︎︎ 𝐉𝐀𝐕𝐀 𝐆𝐎𝐃 ☠︎︎ \` \n*
